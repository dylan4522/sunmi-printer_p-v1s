...
//            Toast.makeText(context, R.string.toast_2,Toast.LENGTH_LONG).show();
    ...
    /**
     * Get PrinterSerial No.
     *
     * @return string
     */
    public String getPrinterSerialNo() {
        String printerSerialNo = "Unknown printer serial no.";
        try {
            printerSerialNo = woyouService.getPrinterSerialNo();
        } catch (RemoteException e) {
            e.printStackTrace();
        }
...
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
     ...
     *
     * @param data
     * @param modulesize unit: dot, values 4 to 16
...
//            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
    ...
    /**
     * printBitmap
     * Bitmap Image Object(Max Width: 384px, <= 1M size)
     * @param imagePath
     * @param alignment
     */
...
//            Toast.makeText(context, R.string.toast_2,Toast.LENGTH_LONG).show();
     ...
     * 打印图片和文字按照指定排列顺序
     */
    public void printBitmap(Bitmap bitmap, int alignment, int orientation) {
        if (woyouService == null) {
